...
const projectLinks = ["AllTrackSystem", "EMEGroupInc", "Portfolio", "Capstone"];
...
describe("renders all page elements", () => {
  ...
  it("should render 5 images on the page: headshot & project images", () => {
    render(<MockHome showModal={false} />);
...
describe("renders links/buttons with proper redirect/action", () => {
  ...
  // Switch this to button instead of link, after I fix the button component
  it("should include 4 project overview buttons with appropriate links", () => {
    render(<MockHome showModal={false} />);
